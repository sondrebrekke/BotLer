...
class ChooseSubjectUITest: XCTestCase {
    ...
    func testExample() {
        ...
        let nrOfCompletedAssignments = app.completedAssignments.size()
        ...
        XCTAssertEqual(FirstOpen.completedAssignments.size(), nrOfCompletedAssignments + 1)
